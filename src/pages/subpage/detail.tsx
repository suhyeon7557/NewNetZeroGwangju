        ...
        <div aria-label='탄소중립 페이지 영역' className='nav_page'>
            ...
            <div id='cont_wrap' aria-label='컨텐츠 영역'>
                <div className='cont_inner'>
                    ...
                    {/* 파일이 없을 때 no_file 클래스 추가 */}
                    <div className='file_wrap'>
                        <div className='file_title'>
                            <h3>첨부파일</h3>
                            <a href='#' className='download_btn all'>전체 다운로드</a>
                        </div>
                        <ul className='file_list'>
                            <li>
                                <a href='#' className='file pdf' title='첨부파일 다운로드'>
                                    <span className='file_icon'></span>
                                    <span className='file_name txt_cut1'>헬프포스터.jpg</span>
                                    <span className='file_info'>(0.76MB / 다운로드 23회)</span>
                                    <span className='download_btn'>다운로드</span>
                                </a>
                            </li>
                            <li>
                                <a href='#' className='file doc' title='첨부파일 다운로드'>
                                    <span className='file_icon'></span>
                                    <span className='file_name txt_cut1'>헬프포스터.jpg</span>
                                    <span className='file_info'>(0.76MB / 다운로드 23회)</span>
                                    <span className='download_btn'>다운로드</span>
                    ...
                    <div className='post_navi_wrap'>
                        <ul>
                            <li className='post_navi prev'>
                                <a href='#' className='navi_link'>
                                    <span className='navi_icon'></span>
                                    <span className='navi_text'>이전글</span>
                                    <span className='navi_title txt_cut1'>[광고 제2025-34호] 2025년 특수교사 대상 현장교육 연수 희망자 모집</span>
                                </a>
                            </li>
                            <li className='post_navi next'>
                                <a href='#' className='navi_link'>
                                    <span className='navi_icon'></span>
                                    <span className='navi_text'>다음글</span>
                                    <span className='navi_title txt_cut1'>2025년 제2회 광주·대구 특별대응 발표포럼 개최</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className='post_btn_wrap'>
                        <a href='#' className='btn_list'>목록보기</a>
                    </div>
