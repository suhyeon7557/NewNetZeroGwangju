...
import "../reportpage/reportpagedetail.scss";
...
const ReportPageDetail = () => {
    ...
    return (
        <div aria-label='연구보고서 디테일 페이지 영역' className='nav_page'>
                ...
                <div className='cont_inner'>
                    ...
                    <div className='report_detail_wrap'>
                        ...
                        <div className='report_book'>
                            ...
                            <button type="button" aria-label='다음 페이지 이동 버튼' className='report_book_next'></button>
                            <button type="button" aria-label='이전 페이지 이동 버튼' className='report_book_prev'></button>
                        </div>
                    </div>
                    <div className='btn_wrap among'>
                        <button type="button" className='btn_lime_bg bd_radius'>
                            목록보기
                        </button>
                    </div>
                </div> 
...
export default ReportPageDetail;